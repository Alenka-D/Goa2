...
class LightModeTheme extends FlutterFlowTheme {
  ...
  late Color primary = const Color(0xFFFF7043);
  late Color secondary = const Color(0xFF80FFAE);
  late Color tertiary = const Color(0xFF00BA44);
  late Color alternate = const Color(0xFFFFFFFF);
  late Color primaryText = const Color(0xFF1D1E20);
  late Color secondaryText = const Color(0xFF8F959E);
